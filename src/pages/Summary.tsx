  ...
  const generateSummary = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:3000/api/summarize-and-send",
        {
          tasks: tasksForApi,
          link: link,
        },
    ...
    try {
      ...
      const apiUrl =
        webhookUrl !== "https://hooks.slack.com/services/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"
          ? "http://localhost:3000/api/summarize-and-send?webhookUrl=" + encodeURIComponent(webhookUrl)
          : "http://localhost:3000/api/summarize-and-send"
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow py-8 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <Card className="mb-8">
            <CardHeader>
              <CardTitle className="font-inter">AI-Generated Summary</CardTitle>
              <CardDescription>
